                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
                            ...
                            <div>
                                ...
                                <div class="flex mt-1 rounded-md shadow-sm">
                                    ...
                                    <x-text-input id="tag_number" class="flex-1 block w-full rounded-none rounded-r-md" type="number" name="tag_number" :value="old('tag_number')" required autofocus placeholder="001" />
                                </div>
                            </div>
