                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('sheep.update', $sheep) }}" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
                            ...
                            {{-- (PERUBAHAN: Input Eartag dengan Prefix Addon dan $tagSuffix) --}}
                            <div>
                            ...
                            <div>
                                ...
                                <x-text-input id="category" class="block w-full mt-1" type="text" name="category" :value="old('category', $sheep->category)" required placeholder="CONTOH: Pedaging/Texel" />
                            </div>
                            <div>
                                <x-input-label for="type" :value="__('Tipe/Ras (Wajib)')" />
                                <x-text-input id="type" class="block w-full mt-1" type="text" name="type" :value="old('type', $sheep->type)" required />
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 gap-6 mt-4 md:grid-cols-4">
                            ...
                            <div>
                                ...
                                <x-text-input id="date_of_birth" class="block w-full mt-1" type="date" name="date_of_birth" :value="old('date_of_birth', $sheep->date_of_birth->format('Y-m-d'))" required />
                            </div>
                            <div>
                        ...
                        <div class="grid grid-cols-1 gap-6 mt-4 md:grid-cols-2">
                            ...
                            <div class="flex items-center mt-6">
                                ...
                                <input id="is_pedigree" name="is_pedigree" type="checkbox" value="1"
                                       {{ (old('is_pedigree', $sheep->is_pedigree) == 1) ? 'checked' : '' }}
                        ...
                        <div class="mt-4">
                            <x-input-label for="photo" :value="__('Foto Domba (Ganti jika ingin diubah)')" />
                            @if($sheep->photo_path)
                                <div class="mt-2">
